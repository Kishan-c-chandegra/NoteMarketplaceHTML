...
namespace NotesMarketPlace.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // get user by key
            User user = _dbcontext.Users.Where(x => x.UserID == key).FirstOrDefault();
        ...
        public ActionResult Login(LoginViewModel loginviewmodel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = _dbcontext.Users.FirstOrDefault(x => x.EmailID == loginviewmodel.Email);
                if (user != null)
                {
                        ...
                        if (user.IsEmailVerified)
                        {
                            ...
                            if (user.Password == loginviewmodel.Password)
                            {
                                ...
                                if (user.RoleID == memberid)
                                {
                                    ...
                                    var isuserprofileset = _dbcontext.UserProfiles.Where(x => x.UserID == user.UserID).FirstOrDefault();
        ...
        public ActionResult ForgotPassword(ForgotPasswordViewModel forgotpasswordviewmodel)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = _dbcontext.Users.FirstOrDefault(x => x.EmailID == forgotpasswordviewmodel.Email && x.IsActive == true);
