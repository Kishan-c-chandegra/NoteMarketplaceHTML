    ...
    public class UserController : Controller
    {
        ...
        public ActionResult UserProfile()
        {
            ...
            if (userprofile != null)
            {
                ...
                userprofileviewmodel.UserID = user.UserID;
        ...
        public ActionResult MyDownloads(string search, string sort, int page = 1)
        {
            ...
            IEnumerable<MyDownloadsViewModel> mydownloads = from download in _dbcontext.Downloads
                                                            join users in _dbcontext.Users on download.Seller equals users.UserID
                                                            ...
                                                            where download.Downloader == user.UserID && download.IsSellerHasAllowedDownload == true && download.AttachementPath != null
                                                            select new MyDownloadsViewModel
                                                            {
                                                                ...
                                                                DownloadedDate = download.AttaachementDownloadID.Value,
                                                                NoteDownloaded = download.IsAttachementDownload,
        ...
        public ActionResult MyRejectedNotes(string search, string sort, int page = 1)
        {
            ...
            IEnumerable<SellerNote> rejectednotes = _dbcontext.SellerNotes.Where(x => x.SellerID == user.UserID && x.Status == rejectedid && x.IsActive == true).ToList();
        ...
        public ActionResult MySoldNotes(string search, string sort, int page = 1)
        {
            ...
            IEnumerable<MySoldNotesViewModel> mysoldnotes = from download in _dbcontext.Downloads
                                                            join users in _dbcontext.Users on download.Downloader equals user.UserID
                                                            where download.Seller == user.UserID && download.IsSellerHasAllowedDownload == true && download.AttachementPath != null
